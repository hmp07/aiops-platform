...
def _register_builtin_tools():
    """Register all builtin MCP platform tools at startup."""
    from app.modules.module8_aiops.services import _register_builtin_mcp_tools
    _register_builtin_mcp_tools()
    logger.info("AIOps builtin MCP tools registered")
...
from app.modules.module8_aiops.mcp_api import router as aiops_mcp_router
...
app.include_router(aiops_mcp_router, prefix="/api/v1")
